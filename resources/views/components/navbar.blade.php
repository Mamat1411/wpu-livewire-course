<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3">
            ...
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">WPU Livewire</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                ...
                <li>
                    <x-nav-link href="{{ route('users') }}" :current="request()->routeIs('users')">
                        Users
                    </x-nav-link>
                </li>
                <li>
                    <x-nav-link href="{{ route('about') }}" :current="request()->routeIs('about')">
                        About
                    </x-nav-link>
                </li>
                <li>
                    <x-nav-link href="{{ route('contact') }}" :current="request()->routeIs('contact')">
                        Contact
                    </x-nav-link>
                </li>
            </ul>
