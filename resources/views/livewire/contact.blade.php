<section class="bg-white mt-10 dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <p class="font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical
            issue? Want to send feedback about a beta feature? Need details about our Business plan? Let us know.</p>
        @if (session('success'))
            <div id="alert-success"
                class="flex items-center p-4 my-4 border border-green-300 text-green-800 rounded-lg bg-green-50"
                role="alert">
        ...
        @endif
        <form action="#" method="POST" wire:submit.prevent='createMessage' class="space-y-6 mt-4">
            <div>
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Your email
                </label>
                <input type="email" id="email" name="email" wire:model='contactForm.email'
            ...
            <div>
                ...
                <input type="text" id="subject" name="subject" wire:model='contactForm.subject'
            ...
            <div class="sm:col-span-2">
                <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">
                    Your message</label>
                <textarea id="message" rows="6" name="message" wire:model='contactForm.message'
            ...
            <button
                ...
                <svg wire:loading wire:target='createMessage' aria-hidden="true"
