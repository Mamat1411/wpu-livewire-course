            ...
            <div class="mt-10">
                <form action="#" method="POST" class="space-y-6" wire:submit.prevent="createUser">
                    ...
                    <div class="col-span-full">
                        <label for="profile-picture" class="block text-sm/6 font-medium text-gray-900">
                            Profile Picture
                        </label>
                        <div
                    ...
                    <div wire:loading wire:target="avatar"
                        class="flex items-center justify-center w-50 h-50 border border-gray-200 rounded-lg bg-gray-50">
                        <div role="status">
                    ...
                    @if ($avatar)
                        ...
                        <img src="{{ $avatar->temporaryUrl() }}" alt="Preview Image"
                            class="rounded w-50 h-50 block object-cover">
                    @endif
    ...
    <div class="w-1/3 my-10">
        ...
        <form class="max-w-lg mx-auto" wire:submit='search'>
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" wire:model.live.debounce.150ms='query'
                ...
                <li class="flex justify-between gap-x-6 py-5">
                    <div class="flex min-w-0 gap-x-4">
                        <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('img/default-avatar.png') }}"
                            alt="avatar" class="size-12 flex-none rounded-full bg-gray-50" />
